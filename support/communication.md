...
The best way for instructional staff to request help with DataHub is through filing a [GitHub issue](https://github.com/berkeley-dsep-infra/datahub/issues/new/choose).

## DataHub Support Email

Reach out to [datahub support](mailto:datahub-support@berkeley.edu) directly if there are time-sensitive issues.
